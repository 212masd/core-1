Usage: gallery-dl.exe [OPTIONS] URL [URL...]
...
Output Options:
  ...
  -N, --print [EVENT:]FORMAT  Write FORMAT during EVENT (default 'prepare') to
                              standard output instead of downloading files.
                              Can be used multiple times. Examples: 'id' or
                              'post:{md5[:8]}'
...
Selection Options:
  -A, --abort N[:TARGET]      Stop current extractor(s) after N consecutive
                              file downloads were skipped. Specify a TARGET to
                              set how many levels to ascend or to which
                              subcategory to jump to. Examples: '-A 3', '-A
                              3:2', '-A 3:manga'
  -T, --terminate N           Stop current & parent extractors and proceed
                              with the next input URL after N consecutive file
  ...
  --filesize-max SIZE         Do not download files larger than SIZE (e.g.
                              500k or 2.5M)
  --download-archive FILE     Record successfully downloaded files in FILE and
...
Post-processing Options:
  ...
  --exec CMD                  Execute CMD for each downloaded file. Supported
                              ...
                              Windows, use {_path_unc} or {_directory_unc} for
                              UNC paths. Example: --exec "convert {} {}.png &&
                              rm {}"
